...
namespace ProcessingUnitDevice {
  ...
  void generate_edge_color(float *h_angle_matrix, unsigned char *h_output_image, dim3 matrix_dim);
}
...
namespace ProcessingUnitHost {
  ...
  void generate_edge_color(float *angle_matrix, unsigned char *output_image, dim3 matrix_dim);
}
